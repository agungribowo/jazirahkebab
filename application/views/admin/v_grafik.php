        ...
        <div class="row">
            <div class="col-md-3 portfolio-item">
                <div class="menu-item blue" style="height:150px;">
                     <a href="<?php echo base_url().'admin/grafik/graf_stok_barang'?>" target="_blank">
                           <i class="fa fa-line-chart"></i>
                            <p style="text-align:center;font-size:14px;padding-left:5px;">Grafik Stok Barang</p>
                      </a>
                </div> 
            </div>
            <div class="col-md-3 portfolio-item">
                <div class="menu-item color" style="height:150px;">
                     <a href="#lap_jual_perbulan" data-toggle="modal">
                           <i class="fa fa-line-chart"></i>
                            <p style="text-align:center;font-size:14px;padding-left:5px;">Grafik Penjualan PerBulan</p>
                      </a>
                </div> 
            </div>
            <div class="col-md-3 portfolio-item">
                <div class="menu-item red" style="height:150px;">
                     <a href="#lap_jual_pertahun" data-toggle="modal">
                           <i class="fa fa-line-chart"></i>
                            <p style="text-align:center;font-size:14px;padding-left:5px;">Grafik Penjualan PerTahun</p>
                      </a>
                </div> 
            </div>
        </div>
