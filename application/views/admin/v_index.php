...
<head>
    ...
    <title>Welcome to Jazirah Kebab Apps</title>
...
<body>
<img src="<?php echo base_url().'assets/img/NewBack.jpg'?>" alt="gambar" class="bg" />
    <!-- Navigation -->
   <?php 
   ...
   ?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header" style="color:#fcc;">Welcome to JAZIRAH KEBAB Apps
                </h1>
            </div>
        </div>
        <!-- /.row -->
